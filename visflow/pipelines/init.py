...
class InitPipeline(BasePipeline):
    ...
    def __init__(self, proxy: str | None = None):
        ...
        self.downloader = HTTPDownloader(
            base_url="https://raw.githubusercontent.com/6ixGODD/visflow/master/", proxy=proxy)
        ...
        aio.run(
            self.downloader.downloads(
                DownloadTask(url=".config.example.yml",
                             ...
                             method="GET",
                             save_url=".config.yml"),
                DownloadTask(url="data/train/README.md",
                             save_to=(p.Path(""),),
                             method="GET",
                             save_url="data/train/README.md"),
                DownloadTask(url="data/test/README.md",
                             save_to=(p.Path(""),),
                             method="GET",
                             save_url="data/test/README.md"),
                DownloadTask(url="data/val/README.md",
                             save_to=(p.Path(""),),
                             method="GET",
