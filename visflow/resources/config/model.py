...
class ModelConfig(pydt.BaseModel):
    architecture: (t.Literal[
        ...
        "swin_v2_b",
        "maxvit_t",
    ] | str) = pydt.Field(default="resnet18", description="Model architecture to use for training.")

    pretrained: bool = pydt.Field(default=True,
                                  description="Whether to use pre-trained weights from ImageNet.")

    num_classes: int = pydt.Field(default=2,
                                  ge=1,
                                  description="Number of output classes for classification.")

    weights_path: str | None = pydt.Field(default=None,
